        ...
        <nav class="bg-white border-b border-gray-200 p-4 sticky top-0 z-50 shadow-sm">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex items-center gap-4 flex-wrap justify-center">
                    ...
                    <a href="bill/rent_bill.php" class="bg-cyan-600 hover:bg-cyan-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all shadow-sm"><i class="fa-solid fa-file-invoice-dollar"></i> จัดการบิลค่าเช่า</a>
                                ...
                                <tbody class="divide-y divide-gray-100 text-gray-700">
                                    ...
                                    <?php foreach ($active_items as $it): $st = $it['status_by_month'][$month] ?? 'ค้างชำระ'; ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="p-3 text-center"><span class="<?= $st === 'จ่ายแล้ว' ? 'text-emerald-600 bg-emerald-50' : 'text-rose-500 bg-rose-50' ?> text-[10px] font-bold border px-2 py-0.5 rounded-full"><?= $st ?></span></td>
                                            <td class="p-3 text-center flex justify-center items-center gap-1.5">
                                                <a href="?action=toggle_status&id=<?= $it['id'] ?>&month=<?= $month ?>" class="text-[10px] text-white px-2 py-1 rounded <?= $st === 'จ่ายแล้ว' ? 'bg-amber-500 hover:bg-amber-600' : 'bg-emerald-600 hover:bg-emerald-700' ?> transition-colors" title="<?= $st === 'จ่ายแล้ว' ? 'ยกเลิกการจ่าย' : 'ทำเครื่องหมายว่าจ่ายแล้ว' ?>"><?= $st === 'จ่ายแล้ว' ? 'ยกเลิก' : 'จ่ายแล้ว' ?></a>
                                                <a href="bill/index.php?type=item&id=<?= $it['id'] ?>&month=<?= $month ?>" target="_blank" class="text-gray-400 hover:text-blue-600 px-1 transition-colors text-xs" title="พิมพ์ใบแจ้งหนี้"><i class="fa-solid fa-print"></i></a>
